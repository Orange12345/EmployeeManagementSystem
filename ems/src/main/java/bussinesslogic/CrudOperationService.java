...
public class CrudOperationService {
	...
	public void deleteEmployee(int empIdelete, HashMap<Integer, Employee> empMap) {
		Optional<Employee> emp=	Optional.ofNullable(empMap.get(empIdelete));
		if(emp.isPresent())
		{
			empMap.remove(empIdelete);
